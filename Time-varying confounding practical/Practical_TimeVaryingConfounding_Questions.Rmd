...
We can download the orginal dataset from https://eclass.uoa.gr/modules/document/index.php?course=MED1174&openDir=/5aabb509gI5h/5abb8578jC7H, and then load it into R. However, as our goal is to replicate the analysis in Cain and Cole (2009), we still need to do some data management to define the \textbf{non-compliance} and \textbf{event (AIDS or death)} variable. For the data management we follow: https://eclass.uoa.gr/modules/document/file.php/MED1174/R%20Labs/A%20case%20study%3A%20The%20ACTG%20320%20protocol/actg320.pdf.
